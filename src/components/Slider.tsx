...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="hidden group-hover:block h-3 w-3 rounded-full border
     bg-white border-primary/50 bg-background shadow transition-colors focus-visible:outline-none 
